...
//https://youtu.be/yOZSUfL-DxQ?si=KG6k4vf-UooEa6bo
...
public:
    int findLengthOfShortestSubarray(vector<int> &arr)
    {
        ...
        // step-2 start finding correct i and j and find deleted elements = j -1-1
        while (i < j && (i == 0 || arr[i] >= arr[i - 1]))
        { // increasing ordere of elements from i
            // arr[j] < arr[i]
