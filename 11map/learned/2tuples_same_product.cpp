...
//https://youtu.be/aC7q-YCFV2o?si=DP7WeYLFqXdJ3HTa
...
//to store the frequency of each product of pairs
...
// number of ways to choose two pairs with the same product
            int pairsOfEqualProduct = (productFrequency - 1) * productFrequency / 2;  //nC2 
